...
const VERDICT_CONFIG = {
  ...
  UNVERIFIED: { color: "#6B6354", lines: ["UNVERIFIED"], fontSize: 14 },
  ERROR:      { color: "#6B6354", lines: ["UNREADABLE"], fontSize: 14 },
};
...
export default function VerdictStamp({ verdict, confidence }) {
  ...
  const filterId = `stampGrain-${uid}`;

  return (
    <div className="w-36 h-36 shrink-0 animate-stamp">
      <svg
        viewBox="0 0 200 200"
